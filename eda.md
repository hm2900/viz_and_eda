...
ungroup() to cancel any grouping.
...
Use janitor::tabyl(x, y)to generate a 2×2 table.
...
min_rank() rank the values from the bottom to the up; min_rank(desc())
rank the values from the up to the bottom.
